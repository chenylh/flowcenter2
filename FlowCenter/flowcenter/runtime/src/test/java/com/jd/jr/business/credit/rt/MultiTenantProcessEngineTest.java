...
public class MultiTenantProcessEngineTest {
	...
	private void setupProcessEngine(boolean sharedExecutor) {
		...
		config.registerTenant("alfresco", createDataSource("jdbc:mysql://localhost:3306/alfresco?characterEncoding=UTF-8", "root", "cyldab"));
		config.registerTenant("acme", createDataSource("jdbc:mysql://localhost:3306/acme?characterEncoding=UTF-8", "root", "cyldab"));
		config.registerTenant("starkindustries", createDataSource("jdbc:mysql://localhost:3306/starkindustries?characterEncoding=UTF-8", "root", "cyldab"));
